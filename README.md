...
**Description:** this is a software only implementation of the audio mixer capable of taking stems and mixing them into a singular output. This will be the basis for our hardware inmplementation of the same algorithm
