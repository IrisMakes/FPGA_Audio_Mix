...
################################################################
# This is a generated script based on design: audio_mix
#
...
proc create_root_design { parentCell } {
  ...
  set FCLK_CLK1_0 [ create_bd_port -dir O FCLK_CLK1_0 ]
  set sclk_out_0 [ create_bd_port -dir O sclk_out_0 ]
  set I2C_AIC_SCL [ create_bd_port -dir IO -from 0 -to 0 I2C_AIC_SCL ]
  set I2C_AIC_SDA [ create_bd_port -dir IO -from 0 -to 0 I2C_AIC_SDA ]
  set switches_0 [ create_bd_port -dir I -from 7 -to 0 -type data switches_0 ]
  ...
  set_property CONFIG.C_DWIDTH {24} $i2s_receiver_0
...
0#I2C 0#GPIO0 MIO#SD 0#SD 0#GPIO0 MIO#SD 0#GPIO0 MIO#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#UART 1#UART 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1\
...
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {23.809521} \
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {24} \
...
\
  ...
  # Create instance: util_ds_buf_scl_0, and set properties
  set util_ds_buf_scl_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.2 util_ds_buf_scl_0 ]
  set_property -dict [list \
  ...
  # Create instance: util_ds_buf_sda_0, and set properties
  set util_ds_buf_sda_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.2 util_ds_buf_sda_0 ]
  set_property CONFIG.C_BUF_TYPE {IOBUF} $util_ds_buf_sda_0
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mixer_0/stream_in]
  ...
  connect_bd_intf_net -intf_net mixer_0_mix_out [get_bd_intf_pins mixer_0/mix_out] [get_bd_intf_pins i2s_transmitter_0/s_axis_aud]
  ...
  connect_bd_net -net Net  [get_bd_ports I2C_AIC_SCL] \
  [get_bd_pins util_ds_buf_scl_0/IOBUF_IO_IO]
  connect_bd_net -net Net1  [get_bd_ports I2C_AIC_SDA] \
  [get_bd_pins util_ds_buf_sda_0/IOBUF_IO_IO]
  ...
  connect_bd_net -net sdata_0_in_0_1  [get_bd_ports sdata_0_in_0] \
  [get_bd_pins i2s_receiver_0/sdata_0_in]
  connect_bd_net -net switches_0_1  [get_bd_ports switches_0] \
  [get_bd_pins mixer_0/switches]
  connect_bd_net -net util_ds_buf_0_IOBUF_IO_O  [get_bd_pins util_ds_buf_scl_0/IOBUF_IO_O] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_i]
  connect_bd_net -net util_ds_buf_sda_0_IOBUF_IO_O  [get_bd_pins util_ds_buf_sda_0/IOBUF_IO_O] \
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs i2s_receiver_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs i2s_transmitter_0/s_axi_ctrl/Reg] -force
